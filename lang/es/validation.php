...
/*
|--------------------------------------------------------------------------
| Líneas de validación en español (Colombia)
|--------------------------------------------------------------------------
| Mensajes usados por el validador de Laravel. Formato DD/MM/AAAA y
| moneda COP se manejan a nivel de helpers/Blade (Épica 3+).
*/
...
return [
    ...
    'ascii' => 'El campo :attribute solo debe contener caracteres ASCII de un byte.',
    ...
    'contains' => 'Al campo :attribute le falta un valor requerado: :values.',
    ...
    'password' => [
        ...
        'uncompromised' => 'El :attribute dado apareció en una filtración de datos. Usa un :attribute distinto.',
    ],
    ...
    /*
    |----------------------------------------------------------------------
    | Mensajes de validación customizados
    |----------------------------------------------------------------------
    */
