...
> 🔧 **Cupo diario estable (2026-09-23, [ADR-0047](DECISIONS.md#adr-0047)).** El "puedes gastar hoy" se congela al inicio del día y muestra el cupo restante: gastar dentro del cupo lo lleva a 0, no baja el promedio. El día siguiente se recompone solo con el saldo real. **Pendiente relacionado**: presupuestos por categoría como sobres opt-in que aparten plata del cupo (resuelve el caso lumpy: mercado, gasolina, servicios); requiere migración, cambios de UI y de flujo de registro, va en su propia rama.
