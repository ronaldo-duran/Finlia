{{--
    Aviso de contraseña cambiada (Plan 02).
...
<head>
    ...
    <title>{{ __('Tu contraseña de :app cambió', ['app' => $appName]) }}</title>
</head>
                    ...
                    <tr>
                        <td style="padding:28px;">
                            ...
                            <p style="margin:0 0 16px; font-size:15px; line-height:1.6; color:#5b6776;">
                                Hola <strong style="color:#1a2330;">{{ $userName }}</strong>, la contraseña de tu cuenta en
                                <strong style="color:#1a2330;">{{ $appName }}</strong> se cambió desde tu perfil.
                                Las demás sesiones se cerraron.
                            </p>

                            <p style="margin:0 0 16px; font-size:15px; line-height:1.6; color:#5b6776;">
                                <strong style="color:#1a2330;">¿No fuiste tú?</strong> Alguien pudo entrar a tu cuenta.
                                Recupera el acceso con tu correo y elige una contraseña nueva:
                            </p>
                    ...
                    <tr>
                        <td style="padding:18px 28px; background-color:#f6f9fc; border-top:1px solid rgba(15,23,42,0.08);">
                            <p style="margin:0; font-size:12px; line-height:1.6; color:#5b6776;">
                                Este es un aviso de seguridad: te llega porque la contraseña de tu cuenta cambió.
